...
/**
 * <a href=
 * "https://www.contentstack.com/docs/developers/apis/content-management-api/#organizations">Organization</a>
 * is the top-level entity in the hierarchy of Contentstack, consisting of
 * stacks and <a
 * href=
 * "https://www.contentstack.com/docs/developers/set-up-stack/about-stack">stack</a>
 * resources, and users.
 * <p>
 * Organization allows easy management of projects as well as users within the
 * Organization.
 */
public class Organization {
     ...
     * The Get all organizations call lists all organizations related to the system
     * user in the order that they were
     * created
     *
     ...
     * @return the organization users throws {@link java.io.IOException} if spaceId
     *         is null.
     */
     ...
     * @return the organization users throws {@link java.io.IOException} when
     *         execute is called.
     */
    public Call<ResponseBody> getSingleOrganization(
            @NotNull String organizationUid,
