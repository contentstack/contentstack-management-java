...
public class GlobalField {
     ...
     * The Service.
     */
    protected GlobalFieldService service;
    /**
     * The Api key.
     */
     ...
     * <p>
     * <b>Note:</b> Only the stack owner, administrator and developer can create global fields
     * <p>
     * <b>Note:</b> You need to use either the stack's Management Token or the user Authtoken (any one is mandatory),
     * along with the stack API key, to make a valid Content Management API request. Read more about authentication.
     *
     ...
     * <p>
     * <b>Warning:</b> If your Global field has been referred within a particular content type, then you will need to
