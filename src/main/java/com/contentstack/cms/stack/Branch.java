...
public class Branch implements Parametron {
     ...
     *
     * @return Call
     * @see <a href= "https://www.contentstack.com/docs/developers/apis/content-management-api/#get-all-branches">Get
     * all branches</a>
     * @since 0.1.0
     */
     ...
     *         the request body
     * @return Call
     * @see <a href= "https://www.contentstack.com/docs/developers/apis/content-management-api/#create-a-branch">Create
     * a branch</a>
     ...
     *
     * @return Call
     * @see <a href= "https://www.contentstack.com/docs/developers/apis/content-management-api/#delete-a-branch">Delete
     * a branch</a>
     * @see #addHeader(String, String) to add headers
     ...
     *     </li>
     *     <li>
     *        You can create an additional revert branch beyond the established limit of 10 branches per stack.
     *        For instance, if you already have 10 branches in your stack, you can perform a merge operation,
     ...
     * @see <a href= "https://www.contentstack.com/docs/developers/branches/merging-branches/"></a>Merging Branches
     */
