...
public class Stack {
     ...
     * manager presses <b>Enter</b>. When
     * this parameter is set to false, the <br>
     ...
     * additionally, lets you add
     * parameters to or modify the settings of an existing stack.
     * </p>
     * <br>
     * <b>Here is a sample of the Request Body:</b>
     * 
     ...
     * <br>
     * <p>
     * The Get all users of a stack call fetches
     * the list of all users of a particular stack
     * </p>
     *
     * @return the call
     */
