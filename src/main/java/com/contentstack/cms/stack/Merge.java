...
/**
 * The Merging Branches functionality enables you to merge two branches, integrating the development changes made in the
 ...
 * <br>
 * You can pass ignore in the default_merge_strategy query parameter, and pass the item_merge_strategies in the request
 * body to override the default strategy and use a different merge strategy for specific content types or global fields
 * <br>
 * <b>Note:</b>
 * <ul>
 *     <li>The merge branches feature is only available for the content types and global fields modules.</li>
 *     <li>You can create an additional revert branch beyond the established maximum limit of branches per stack. For instance,
 *     if you already have reached the maximum limit of branches in your stack, you can perform a merge operation,
 *     provided that you manually delete the backup branch or any other branch before attempting the next merge.
 *     </li>
 * </ul>
 *
 * @author ishaileshmishra
 * @version v1.0.0
 * @see <a href= "https://stag-www.contentstack.com/docs/developers/apis/content-management-api/#merge-branches">Merge
 * Branches </a>
 * @since 2023 -June-30
 */
public class Merge implements Parametron {
     ...
     * Merging Branches.
     * <br>
     * You can pass ignore in the default_merge_strategy query parameter, and pass the item_merge_strategies in the
     * request body to override the default strategy and use a different merge strategy for specific content types or
     * global fields.
     * <br>
     * <b>Note:</b>
     * <br>
     ...
     *     </li>
     *     <li>
     *       You can create an additional revert branch beyond the established maximum limit of branches per stack. For instance,
     *       if you already have reached the maximum limit of branches in your stack, you can perform a merge operation,
     *       provided that you manually delete the backup branch or any other branch before attempting the next merge.
     *     </li>
     * </ul>
     *
     * @param compareBranch
     *         The branch from which you want to merge changes into the base branch.
     * @param requestBody
     *         the request body
     * @param defaultMergeStrategy
     *         Specify the merge strategy to apply for the merge action. <b>Example:</b> merge_prefere_base
     * @param mergeComment
     *         The comment to be displayed for the merge action
     * @return Call
     */
    public Call<ResponseBody> branch(@NotNull String compareBranch, JSONObject requestBody, @NotNull String defaultMergeStrategy, @NotNull String mergeComment) {
     ...
     * @return the call
     * @see <a href=
     * "https://stag-www.contentstack.com/docs/developers/apis/content-management-api/#get-single-merge-job"></a>Get a
     * Single Merge Job
     */
