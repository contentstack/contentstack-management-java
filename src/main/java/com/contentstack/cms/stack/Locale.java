...
public class Locale {
     ...
     *
     * When executing the API call, under the <b>Header</b> section, you need to enter
     ...
     *
     * To learn more about the queries, refer to the <b>Queries</b> section of the Content
     * Delivery API doc.
     *
     ...
     * supported language or a custom language of your choice.
     *
     * When executing the API call, under the <b>Header</b> section, you need to enter
     * the API key of your stack and the authtoken that you receive after logging
     * into your account.
     *
     * In the 'Body' section, enter the language name and code in JSON format. You
     * can also specify the fallback language you want to assign to the new language
     ...
     * name) and the fallback language of an existing language of your stack.
     *
     * When executing the API call, under the 'Header' section, you need to enter
     * the authtoken that you receive after logging into your account.
     *
     ...
     * language for an entry in a particular language.
     *
     * When executing the API call, under the <b>Header</b> section, you need to enter
     * the API key of your stack and the authtoken that you receive after logging in
     * to your account.
     *
     ...
     * language for an existing language of your stack.
     *
     * When executing the API call, under the <b>Header</b> section, you need to enter
     * the API key of your stack and the authtoken that you receive after logging in
     * to your account.
     *
     * In the <b>Body</b> section, enter the updated details of the fallback language in
     * JSON format
     *
     * @param localeUid the locale uid
     * @param body  the request body
     * @return the retrofit2.Call
     */
