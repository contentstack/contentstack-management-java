...
public interface ContentTypeService {
        ...
        Call<ResponseBody> single(@HeaderMap Map<String, Object> headers,
        ...
        Call<ResponseBody> imports(@HeaderMap Map<String, Object> headers);

        @POST("content_types/import?overwrite=true")
        Call<ResponseBody> importOverwrite(@HeaderMap Map<String, Object> headers);
