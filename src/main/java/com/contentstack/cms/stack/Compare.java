...
/**
 * With the Comparing Branches, you can compare and check the differences
...
public class Compare implements BaseImplementation {
     ...
     * <ul>
     * <li>
     * <b>skip</b> - The number of branches to be skipped from the response body. :
     * Example: 2
     * </li>
     * <li>
     * <b>limit</b> - The maximum number of branches compare result to be returned.
     * The default limit is set at 100.
     * </li>
     * </ul>
     *
     * @return the call
     ...
     * <br>
     * The Compare content types between branches request returns a list of all the
     * differences in content types between
     ...
     * <br>
     * The Compare specific global field between branches request returns all the
    ...
    /**
     * The Compare specific content type between branches request returns all the
