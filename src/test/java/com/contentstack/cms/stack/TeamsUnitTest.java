...
//    @Test
//    void findTest() {
//        Request request = teams.find().request();
...
//        teams.addParam("limit", 2);
//        teams.addParam("skip", 2);
//        teams.addParam("include_count", false);
//        Request request = teams.find().request();
//        Assertions.assertEquals(2, request.headers().names().size());
//        Assertions.assertEquals("GET", request.method());
//        Assertions.assertTrue(request.url().isHttps());
...
//        teams.clearParams();
//        teams.addParam("include_rules", true);
//        teams.addParam("include_permissions", true);
//        Request request = teams.find().request();
//        Assertions.assertEquals(2, request.headers().names().size());
//        Assertions.assertEquals("GET", request.method());
//        Assertions.assertTrue(request.url().isHttps());
...
//    @Test
//    void fetchTest() {
//        Request request = teams.fetch("taxonomyId").request();
//        Assertions.assertEquals(2, request.headers().names().size());
//        Assertions.assertEquals("GET", request.method());
//        Assertions.assertTrue(request.url().isHttps());
//        Assertions.assertEquals("api.contentstack.io", request.url().host());
...
//    @Test
//    void updateTest() {
//        Request request = teams.update("taxonomyId", body).request();
//        Assertions.assertEquals(2, request.headers().names().size());
...
//    @Test
//    void deleteTest() {
//        Request request = teams.delete("taxonomyId").request();
...
//        teams.clearParams();
//        teams.addHeader("Content-Type", "application/json");
...
//        teams.addHeaders(headers);
//        teams.addParams(params);
//        Request request = teams.delete("taxonomyId").request();
//        Assertions.assertEquals(5, request.headers().names().size());
//        Assertions.assertEquals("DELETE", request.method());
//        Assertions.assertTrue(request.url().isHttps());
...
//        obj.put("name", "sample");
//        Request request = teams.create(obj).request();
