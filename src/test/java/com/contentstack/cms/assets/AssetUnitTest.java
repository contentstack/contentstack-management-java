...
class AssetUnitTest {
        ...
        @BeforeAll
        static void setup() {
                asset = new Contentstack.Builder().setAuthtoken(_AUTHTOKEN).build().asset(API_KEY, MANAGEMENT_TOKEN);
        }
        ...
        void testAssetSingle() {
                ...
                Assertions.assertNull(resp.body());
                Assertions.assertEquals(
                                "https://api.contentstack.io/v3/assets/blt5f8b960a26267639?relative_urls=false&environment=production&include_path=false&include_publish_details=true&version=1",
                                resp.url().toString());
        }
        ...
        void testAssetSubfolder() {
                ...
                Assertions.assertNull(resp.body());
                Assertions.assertEquals(
                                "https://api.contentstack.io/v3/assets?folder=blt5f8b960a26267639&query={%22is_dir%22:true}&include_folders=true",
                                resp.url().toString());
        }
